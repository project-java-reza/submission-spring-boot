...
import com.enigma.wms_api.model.request.BillDetailRequest;
...
public class BillServiceImpl implements BillService {
    ...
    public BillResponse create(BillRequest request) {
        ...
        for (BillDetailRequest newBillDetailRequest : request.getBillDetails()) {
        ...
        ReceiptSequenceRequest receiptSequence = ReceiptSequenceRequest.builder()
    ...
    @Override
    public Page<BillResponse> getAll(BillRequest request) {
    ...
    @Override
    public TotalSales getSalesHistory(SalesHistoryRequest request) {
